...
public class LeftPanelController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        updateList(Paths.get(".")); //Обновляем список файлов в левом окне
    }
    ...
    public void uploadToServer(ActionEvent actionEvent) { //Загрузить на сервер
    }
}